...
class UR3Kinematics:
    ...
    def jacobienne(self,joint_angles) :
        ...
        OP2=T06[0:3,3]-T02[0:3,3]
        OP3=T06[0:3,3]-T03[0:3,3]
        OP4=T06[0:3,3]-T04[0:3,3]
        OP5=T06[0:3,3]-T05[0:3,3]
        OP6=T06[0:3,3]-T06[0:3,3]
...
class OmniStateToTwistWithButton(Node):
    ...
    def omni_state_callback(self, msg: OmniState):
        ...
        #Transformation de repères postions 
        linear_velocity_outil = np.array([twist_msg.twist.linear.x, 
                                    twist_msg.twist.linear.y, 
                                    twist_msg.twist.linear.z])
        
        linear_velocity_base=np.dot(J[3:6],linear_velocity_outil)
        ...
        #Transformation orientatons 
        angular_velocity_outil=np.array([twist_msg.twist.angular.x,
                                         twist_msg.twist.angular.y,
                                         twist_msg.twist.angular.z])
        angular_velocity_base=np.dot(J[0:2],angular_velocity_outil)
