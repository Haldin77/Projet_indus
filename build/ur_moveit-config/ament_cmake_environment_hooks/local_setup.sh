...
: ${AMENT_CURRENT_PREFIX:="/home/projet-echo/Projet_indus/install/ur_moveit-config"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/ur_moveit-config/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/ur_moveit-config/environment/path.sh"
